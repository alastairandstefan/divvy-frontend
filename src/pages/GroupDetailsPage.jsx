...
const GroupDetailsPage = () => {
  ...
  const { data: group, isLoading: isLoadingGroup, error: groupError } = useQuery("group", fetchGroup);
  const { data: expenses, isLoading: isLoadingExpenses, error: expensesError } = useQuery("expenses", fetchExpenses);
