...
const DashboardPage = () => {
  ...
  return (
    <div className="DASHBOARD flex flex-col justify-between h-[90vh] p-3 bg-appbg">
      <div className="flex-grow">
        <div className="RECEIPT flex grow h-auto flex-col min-h-[45%] " style={{ filter: `drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.2))` }}>
          <div className="w-full bg-receipt h-full max-h-[60  %]">
            {user.name ? (
              <h1 className="text-center pt-3">
                <span className="font-bold">Hi {user.name}</span>, <br /> here is
          ...
          <div className="">
            <svg
              className="ribbon w-full h-auto"
              height="17"
              viewBox="0 0 368 17"
              fill="none"
