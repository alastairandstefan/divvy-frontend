  ...
  return (
    <div className="DASHBOARD flex flex-col w-full items-center p-2 bg-appbg h-[92.5%] overflow-visible">
      ...
      <div className="w-full md:w-[25%] bg-receipt p-4 flex flex-col md:h-[60%] justify-evenly">
        ...
        <p>
          Welcome to D%VVY, our solution for simplifying expense tracking and
          splitting costs effortlessly.
        </p>
        ...
        <p>
          The frontend is powered by React, utilising React Query for data
          fetching and caching requirements.
        </p>
